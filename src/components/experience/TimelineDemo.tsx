    ...
    const data = [
            ...
            content: (
                <div>
                    <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
                        Leading full-stack development with cutting-edge AI and blockchain technologies. Built advanced
                        portfolio website with generative UI components and integrated OpenAI APIs.
                    </p>
                    <div className="mb-6">
        ...
        },
        {
            ...
            content: (
                <div>
                    <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
                        Specialized in blockchain development and DeFi protocols. Built smart contracts and
                        decentralized applications with focus on Web3 integration and user experience.
                    </p>
                    <div className="mb-6">
                        <h4 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-3">
            ...
            content: (
                <div>
                    <p className="mb-4 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
                        Started my journey in full-stack development, mastering modern web technologies and building
